...
supplidata = str(input("please enter key: "))
with open("database.json", "r") as file:
    json_file = json.load(file)
    database = json_file['data']
    for userz in database:
        if userz['key'] == supplidata:
            ...
            if now <= subtime:
                ...
                print("you somehow triggered an error lol")
        else:
                pass
    else:
            print("it seems like you inputted a key that dosnt match with any entry key in the database")
            sys.exit()
    print("hello, you are now authinticated. Only cool people will see this")
...
print(" ╚█████╔╝╚█████╔╝██████╔╝██║░╚═╝░██║╚█████╔╝██████╔╝  ╚██████╔╝███████╗██║░╚███║ ")
print(" ░╚════╝░░╚════╝░╚═════╝░╚═╝░░░░░╚═╝░╚════╝░╚═════╝░  ░╚═════╝░╚══════╝╚═╝░░╚══╝ ")
print("made by cre#8591 ")
print("the gen is starting")
